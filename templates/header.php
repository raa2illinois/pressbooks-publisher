<header class="banner">
  <div class="container">
    <div class="link-wrap">
		...
		<a href="https://pb-sandbox.library.illinois.edu" class="iopn_brand"><img src="<?php bloginfo( 'template_url' ); ?>/images/iopn_color.png" alt="pressbooks-branding"/> <span><?php _e; ?></span></a>
